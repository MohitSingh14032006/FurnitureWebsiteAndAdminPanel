...
export default function ForgotPasswordForm() {
  ...
  const handleSubmit = (e) => {
    ...
    setMessage(`Password reset instructions were sent to ${email}. Redirecting to login...`)
  ...
  return (
        <div className="flex flex-1 items-center justify-center p-8 sm:p-10 lg:p-14">
          <div className="w-full max-w-md">
            <div className="mb-6">
              <h2 className="font-playfair text-3xl font-semibold">Reset password</h2>
              <p className="mt-2 text-sm text-dark-gray">We’ll send a reset link to your email.</p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div>
                <label htmlFor="email" className="mb-2 block text-sm font-medium text-dark-gray">
                  Email address
                </label>
                <input
                  id="email"
